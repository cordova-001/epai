                        ...
                        <div class="toggle-expand-content" data-content="more-options">
                          <ul class="nk-block-tools g-3">
                            ...
                            <li class="nk-block-tools-opt">
                              ...
                              <a class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal" href="#instructor-add"><em class="icon ni ni-plus"></em><span>Add Center</span></a>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist">
                          ...
                          while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            // $chk = "/SELECT * FROM customer WHERE center"
            ...
            <div class="row gy-4">
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-label" for="first-name">Select Branch</label>
                  <div class="form-control-wrap">
                    <select class='form-select js-select2' name='branch'>
                      <?php
                      include 'php/connect.inc.php';
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label class="form-label" for="first-name">Center Name</label>
                  <input type="text" name="center" class="form-control" id="first-name" placeholder="Branch name">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="center_id" class="form-control" readonly value="<?php echo rand(12345, 99999); ?>" id="address-st" placeholder="Branch Id">
                </div>
              </div>
              ...
              <div class="col-md-12">
                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                  <li>
                    <button name="createCenter" class="btn btn-primary">Add Center</button>
                  </li>
