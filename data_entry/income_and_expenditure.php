                ...
                <div class="nk-block-head nk-block-head-sm">
                  <div class="nk-block-between">
                    <div class="nk-block-head-content">
                      <h3 class="nk-block-title page-title">Income and Expenditure Account</h3>
                        ...
                        <div class="tab-pane active" id="tabItem5">
                          ...
                          <form action="process_loan.php" method="GET" class="gy-3 form-settings">
                            ...
                            <div class="row g-3 align-center">
                              <div class="col-lg-4">
                                <div class="form-group">
                                  <label class="form-label" for="site-copyright">Purpose</label>
                            ...
                            <div class="row g-3 align-center">
                              <div class="col-lg-4">
                                <div class="form-group">
                                  <label class="form-label" for="site-copyright"> Amount</label>
                            ...
                            <div class="row g-3">
                              <div class="col-lg-7">
                                <div class="form-group mt-2">
                                  <button type="submit" name="request_loan" class="btn btn-lg btn-primary">Proceed</button>
                                </div>
                              </div>
                            </div>
                          </form>
                ...
                <div class="nk-block nk-block-lg">
                  <div class="card">
                    <div class="card-inner">
                      <div class="tab-content">
                        <div class="tab-pane active" id="tabItem5">
                          <h4 class="title nk-block-title">Expenditure Account</h4>
                          <p>Processing of loan application.</p>
                          <form action="process_loan.php" method="GET" class="gy-3 form-settings">
                            <div class="row g-3 align-center">
                              <div class="col-lg-4">
