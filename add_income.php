                        ...
                        <div class="tab-pane active" id="tabItem5">
                          ...
                          <form action="deposit_details.php" method="GET" class="gy-3 form-settings">
                            ...
                            <div class="row g-3 align-center">
                              <div class="col-lg-4">
                                <div class="form-group">
                                  <label class="form-label" for="site-email">Income Type</label>
                              ...
                              <div class="col-lg-8">
                                <div class="form-group">
                                  <div class="form-control-wrap">
                                    <select class='form-select js-select2' name='name'>
                                      <?php
                                      include 'php/connect.inc.php';
                                      $select = "SELECT * FROM chart_of_account WHERE type = 'Revenues'";
                            ...
                            <div class="row g-3 align-center">
                              <div class="col-lg-4">
                                <div class="form-group">
                                  <label class="form-label" for="site-copyright">Income Amount</label>
